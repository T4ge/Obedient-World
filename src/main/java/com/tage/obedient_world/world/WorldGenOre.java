...
import com.tage.obedient_world.util.ObedientData.OreInformation;
...
public class WorldGenOre implements IWorldGenerator 
{
	...
	{
		for (Iterator<Entry<String, OreInformation>> it = ObedientData.registeredOres.entrySet().iterator(); it.hasNext();)
		{
